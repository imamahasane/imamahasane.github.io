...
export const flagshipProjects: ResearchProject[] = [
  ...
  },
  {
    ...
    contribution:
      "Trades diffusion-model accuracy for GAN-level inference speed while retaining edge fidelity, in an international collaboration with Dr. Mohammad Azam Khan at KAIST. A closely related sinogram-encoded variant targeting real-time measurement-domain noise suppression was accepted as a separate paper in Computers, Materials and Continua (J2).",
    status: "under-review",
    publicationId: "R3",
